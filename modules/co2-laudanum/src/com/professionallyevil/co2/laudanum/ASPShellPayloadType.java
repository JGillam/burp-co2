...
public class ASPShellPayloadType extends PayloadType {

    @Override
    public void savePayload(Component parentComponent, String acceptIPs, String acceptToken) throws Exception {
        File file = chooseFile(parentComponent, "shell.asp", "Choose asp filename");
        if (file != null) {
    ...
    @Override
    String getTemplate() {
        return "com/professionallyevil/co2/laudanum/asp/shell.asp";
    }
}
